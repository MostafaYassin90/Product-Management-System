...
function Login() {
  ...
  // onSubmitHandler
  const onSubmitHandler: SubmitHandler<TLoginUser> = async (data: TLoginUser) => {
    setLoading(true);
    const user = {
      email: data.email,
        ...
        loading
          ...
          <div className="login">
            <div className="holder-form">
              ...
              <div className="goToRegister"><p>Don't have an account?  <Link href={"/register"}>Register</Link></p></div>
              {/* Form */}
